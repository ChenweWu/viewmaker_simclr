...
class MobileNetV3(nn.Module):
  def __init__(self, in_channels: int, inverted_residual_setting: List[InvertedResidualConfig],
               last_channel: int, block: Optional[Callable[..., nn.Module]] = None,
    ...
    Args:
      ...
      last_channel (int): The number of channels on the final layer
    ...
    self.fc = nn.Linear(lastconv_output_channels, last_channel)
...
def mobilenet_v3_large(input_channels: int) -> MobileNetV3:
  """
  ...
  return MobileNetV3(input_channels, inverted_residual_setting, last_channel)


def mobilenet_v3_small(input_channels: int) -> MobileNetV3:
  """
